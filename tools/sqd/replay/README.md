...
```bash
python tools/sqd/replay/replay.py --probe h2 --output /path/to/new-run/h2.json
python tools/sqd/replay/replay.py --probe reference --output /path/to/new-run/reference.json
python tools/sqd/replay/replay.py --probe transpose --output /path/to/new-run/transpose.json
python tools/sqd/replay/replay.py --probe lazy --output /path/to/new-run/lazy.json
```
